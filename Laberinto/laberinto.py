...
class Laberinto():
    ...
    def solve(self):
        ...
        print("inicio_estado",inicio.estado)
        print("inicio_accion",inicio.accion)
        print("inicio_padre",inicio.padre)
        ...
        while True:
            ...
            print("nodo_estado",nodo.estado)
            print("nodo_accion",nodo.accion)
            print("nodo_padre",nodo.padre)
