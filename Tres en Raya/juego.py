...
letraChica = pygame.font.Font("OpenSans-Regular.ttf", 28)
letraGrande = pygame.font.Font("OpenSans-Regular.ttf", 40)
letraMovimiento = pygame.font.Font("OpenSans-Regular.ttf", 60)
